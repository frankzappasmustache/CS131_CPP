...
{
    return RationalNumber(numerator * s.denominator - denominator * s.numerator, denominator * s.denominator);
} // end function operator-

// overloaded * operator
RationalNumber RationalNumber::operator*(const RationalNumber &m)
{
    return RationalNumber(numerator * m.numerator, denominator * m.denominator);
} // end function operator*
...
RationalNumber RationalNumber::operator/(const RationalNumber &d)
{
    ...
    {
        return RationalNumber(numerator * d.denominator, denominator * d.numerator);
    } // end if
    else
    {
...
int main()
{
    ...
    cin >> n;
    cin >> d;
    RationalNumber c(n, d);
    RationalNumber b(n, d);
